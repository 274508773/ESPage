...
ES.CloudMap.PopGridWnd = ES.CloudMap.PopWnd.extend({
    ...
    editShow: function (oData) {
        ...
        //var nWndH = $(this.oOption.cContainerSel).height();
        //var nWndW = $(this.oOption.cContainerSel).width();
        //oPos.y = nWndH/2;
        //oPos.x = nWndW/2;
...
// 树的选择初始化
ES.CloudMap.PopGridWnd.include({
