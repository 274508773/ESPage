...
ES.CloudMap.PostPos = ES.Evented.extend({
...
// 管理面板
ES.CloudMap.PostPos.include({

    // 树面板
    initPenal: function () {
        this.oPenal = new ES.CloudMap.TagTree(this, {}, {
            core: {
                'animation': 0,
                'check_callback': true,
...
ES.CloudMap.PostPos.include({
    ...
    initEditTool:function(){
        // 编辑
        this.aoEditTool.push(new ES.CloudMap.EditTool(this,{oDrawLayer: this._oDrawLayer}));
...
ES.CloudMap.PostPos.include({
    ...
    initDrawTool:function(){
        this.aoTool.push(new ES.CloudMap.DrawMarker(this,{}));
    },
