...
ES.HGT.CloudMap.PostPosLayer = L.MapLib.MapMaster.MapOpr.extend({
    ...
    _loadOn: function () {
        ...
        // 画所有的工地数据
        this._oParent.on('CloudMap:PostPos.drawLayers', this.drawLayers, this);

        this._oParent.on('CloudMap:PostPos.clearLayers', this.clearLayers, this);
