var fs = require('fs'),
	...
	deps = require('./deps_base.js').deps;
...
function getFiles(compsBase32) {
	...
	//var depdds = require('./deps_base.js').deps;
...
exports.build = function (callback, compsBase32, buildName, vertion) {
	...
	var copy = fs.readFileSync('src/copyright.js', 'utf8').replace('{VERSION}', vertion).replace('{NAME}',buildName),
		...
		pathPart = 'D:\\ESWorkCode\\红谷滩渣土管理系统\\HGTMuck\\HGTMuck\\Asset\\scripts\\base\\'+buildName + '-' + vertion ,
